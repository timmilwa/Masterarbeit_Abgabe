  ...
  const handleApiKeyChange = async () => {
    if (window.aistudio && window.aistudio.openSelectKey) {
      try {
        ...
        resetAI();
        alert("API Key aktualisiert. Bitte starte die Analyse erneut.");
      } catch (e) {
    ...
    <div className="h-screen w-full bg-slate-50 flex items-center justify-center p-2 sm:p-4 overflow-hidden">
      ...
      <div className="absolute top-2 right-4 z-50">
         <button 
          ...
          className="text-[10px] uppercase font-bold tracking-wider text-gray-400 hover:text-gray-600 transition-colors"
        >
          API Key
        </button>
      </div>
